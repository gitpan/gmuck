$Id: GMUCK.pod,v 1.5 2003/09/04 18:46:37 scop Exp $
...
You may get errors about the JavaScript media type "text/javascript"
being unregistered, and a recommendation to use "application/x-javascript"
instead.  However, Microsoft Internet Explorer 6.0 has been reported not
to execute "application/x-javascript" scripts.  If you are concerned about
this, just use "text/javascript" and ignore the error.  See
E<lt>URL:http://www.robinlionheart.com/stds/html4/scripts.htmlE<gt>
for a good explanation about this.  Earlier versions of IE don't seem to
be affected.
...
Ville SkyttE<228> E<lt>ville.skytta at iki.fiE<gt>

=head1 COPYRIGHT

Copyright (C) 2001-2003 Ville SkyttE<228>.  All rights reserved.
